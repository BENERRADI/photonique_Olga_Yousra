...
${OBJECTDIR}/exposure.o: exposure.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -Iinclude -I. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/exposure.o exposure.cpp
...
${OBJECTDIR}/stitching.o: stitching.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -Iinclude -I. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/stitching.o stitching.cpp
